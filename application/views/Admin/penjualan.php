<h3>Penjualan Yang belum diapprove</h3>
 </form>
    <div class="card">
  ...
  <div class="row">
    ...
    <h3 style="margin-top:10%;">Penjualan Yang belum diapprove</h3>
 </form>
    <div class="card">
  <div class="table-responsive">
    <table class="table align-items-center mb-0">
      ...
      <?php  
        $no = 1;
        foreach($approved_penjualan as $user){
        ?>
        <tr>
          <td>
            <div class="d-flex px-2 py-1">
          ...
          <td>
            <p class="text-xs font-weight-bold mb-0"><?=$user->status_pengiriman?></p>
          </td>
          <td class="align-middle" style="margin-top: 10px;">
            <button type="button" class="btn bg-gradient-warning" data-original-title="approve " data-bs-toggle="modal" data-bs-target="#approve<?=$user->pesanan_id?>">
              detail
