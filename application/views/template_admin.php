...
<body class="g-sidenav-show  bg-gray-100">
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
    <div class="sidenav-header">
      ...
      <a class="navbar-brand m-0" href="<?= base_url('home') ?>" target="_blank">
        ...
        <span class="ms-1 font-weight-bold">FBA</span>
      </a>
    </div>
    ...
    <div class="collapse navbar-collapse  w-auto  max-height-vh-100 h-100" id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link <?php if ($menu == 'penjual') echo 'active'; ?>" href="<?= base_url('/admin/penjual') ?>">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
              <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                <title>office</title>
                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
            ...
            <span class="nav-link-text ms-1">Penjual </span>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link  <?php if ($menu == 'produk') echo 'active'; ?>" href="<?= base_url('/admin/produk') ?>">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
        ...
        <li class="nav-item">
          <a class="nav-link    <?php if ($menu == 'penjualan') echo 'active'; ?>" href="<?= base_url('admin/penjualan') ?>">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
        ...
        <li class="nav-item">
          <a class="nav-link    <?php if ($menu == 'ketegori') echo 'active'; ?>" href="<?= base_url('admin/kategori') ?>">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
        ...
        <li class="nav-item">
          <a class="nav-link    <?php if ($menu == 'dokumentasi') echo 'active'; ?>" href="<?= base_url('admin/dokumentasi') ?>">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
              <svg class="text-dark" width="16px" height="16px" viewBox="0 0 40 44" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                <title>document</title>
                <g id="Basic-Elements" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
    ...
    <div class="sidenav-footer mx-3">
      ...
      <a class="btn bg-gradient-danger mt-4 w-100" href="<?= base_url('Auth/logout') ?>" type="button">Log Out</a>
    </div>
  ...
  <main class="main-content position-relative max-height-vh-100 h-100 mt-1 border-radius-lg ">
      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            <li class="breadcrumb-item text-sm"><a class="opacity-5 text-dark" href="javascript:;">FBA</a></li>
    ...
    <script>
        <?php if ($this->session->flashdata('alert')): 
            $alert = explode('|', $this->session->flashdata('alert')); ?>
            Swal.fire({
                icon: '<?= $alert[0] ?>',
                title: 'Notification',
                text: '<?= $alert[1] ?>'
  ...
  <script>
    tinymce.init({
      selector: 'textarea', // Pilih elemen textarea yang akan diubah menjadi TinyMCE
  ...
  <script>
    $('#ilang').delay('slow').slideDown('slow').delay(100).slideUp(600);
  </script>
  <!-- Github buttons -->
